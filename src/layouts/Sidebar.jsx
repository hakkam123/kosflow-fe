...
const Sidebar = () => {
  ...
  const handleLogout = () => {
    setFlashAlert({
      ...
      description:
        "Anda telah keluar dari dashboard. Silakan login kembali jika ingin melanjutkan.",
    });
    logout();
    navigate("/login");
  };
  ...
  return (
    ...
    >
      ...
      `}
      >
        <div className="w-9 h-9 bg-primary-500 rounded-lg flex items-center justify-center text-white font-bold text-lg shrink-0">
          K
        </div>
        {!collapsed && (
      ...
      <div className="border-t border-gray-800 p-3">
        ...
        `}
        >
          <div className="w-9 h-9 bg-primary-600 rounded-full flex items-center justify-center text-white font-medium shrink-0">
