...
const UserLoginOTP = () => {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      ...
      setFlashAlert({
        ...
        description: "Anda berhasil masuk ke dashboard penghuni.",
      });
      navigate("/user/dashboard", {
        state: {
          user: {
            id: 1,
            nama_lengkap: "Penghuni Kos",
            username: "penghuni",
            role: "Penghuni",
          },
        },
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-112.5 bg-white min-h-[80vh] rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col border border-slate-100">
        {/* Header/Banner Area */}
        <div className="bg-linear-to-br from-primary-600 to-primary-800 p-10 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="text-primary-100 text-sm">
              Masukkan kode OTP yang dikirimkan oleh pengelola kos untuk masuk
              ke dashboard Anda.
            </p>
          </div>
        </div>
        ...
        <div className="p-8 text-center border-t border-slate-50">
          <p className="text-xs text-slate-400">
            &copy; 2024 KosFlow Management System. <br /> Keamanan data Anda
